    ...
    <div {{-- class="bg-white" --}}>
          ...
          <nav class="flex items-center justify-between p-6 sm:px-8" aria-label="Global">
            <div class="flex sm:flex-1">
              <a href="#" class="-m-1.5 p-1.5">
                ...
                <img class="h-8 w-auto" src="RenObutECommerceLogo/1.png" alt="">
              </a>
            </div>
            ...
            <div class="hidden sm:flex sm:gap-x-12">
              <a href="#" class="text-sm font-semibold leading-6 text-gray-900 hover:text-lime-500">Product</a>
              <a href="#" class="text-sm font-semibold leading-6 text-gray-900 hover:text-lime-500">Features</a>
              <a href="#" class="text-sm font-semibold leading-6 text-gray-900 hover:text-lime-500">Marketplace</a>
              <a href="#" class="text-sm font-semibold leading-6 text-gray-900 hover:text-lime-500">Company</a>
            </div>
              ...
              <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/10">
                  <div class="space-y-2 py-6">
                    <a href="#" class="-mx-3 block rounded-sm px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Product</a>
        ...
        <div class="relative isolate px-6 pt-14 sm:px-8">
          <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
            <div class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#fb923c] to-[#65A30D] {{-- from-[#ff80b5] to-[#9089fc] --}} opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
          </div>
          ...
          <div class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]" aria-hidden="true">
            <div class="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#fb923c] to-[#65A30D] opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
          </div>
        </div>
      </div>
